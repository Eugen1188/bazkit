...
LIQUID_DENSITY_GRAMS_PER_ML = {
    ...
    "Helle Sojasauce": Decimal("1.16"),
    "Dunkle Sojasauce": Decimal("1.20"),
    "Hoisinsauce": Decimal("1.20"),
    "Geröstetes Sesamöl": Decimal("0.92"),
    ...
    "Sahne": Decimal("0.99"),
    "Sake": Decimal("1"),
    "Salzreduzierte Sojasauce": Decimal("1.15"),
    "Sesamöl": Decimal("0.92"),
    ...
    "Tamari": Decimal("1.16"),
    "Austernsauce": Decimal("1.20"),
    "Rotweinessig": Decimal("1.01"),
    "Weißweinessig": Decimal("1.01"),
...
LIQUID_SPOON_INGREDIENTS = {
    "Ahornsirup", "Apfelessig", "Austernsauce", "Balsamicoessig",
    "Dunkle Sojasauce", "Fischsauce", "Geröstetes Sesamöl", "Helle Sojasauce", "Hoisinsauce",
    "Olivenöl", "Rapsöl", "Sahne", "Sake", "Salzreduzierte Sojasauce",
    "Sesamöl", "Shoyu", "Sojasauce", "Sonnenblumenöl", "Tamari",
    "Vanilleextrakt", "Rotweinessig", "Weißweinessig",
}
...
CURATED_KITCHEN_CONVERSIONS = {
    ...
    "Paprikapulver edelsüß": (("TL", Decimal("2.3")), ("EL", Decimal("7")), ("Prise", Decimal("0.2"))),
    "Paprikapulver rosenscharf": (("TL", Decimal("2.3")), ("EL", Decimal("7")), ("Prise", Decimal("0.2"))),
    ...
    "Basmatireis": (("Tasse", Decimal("200")),),
    "Jasminreis": (("Tasse", Decimal("200")),),
...
GRAM_ONLY_INGREDIENTS = {
    ...
    "Paprikapulver", "Paprikapulver edelsüß", "Paprikapulver rosenscharf",
    "Petersilie", "Rosmarin", "Rosmarin getrocknet",
